...
output_model=/data/LPJ/ICML25/all_checkpoints/fine_tune_qformer_havenqwen_using_1989_57_with_lora/v0_cleaned_graph_3epoch_separate_lr_gnn8e4_qformer2e4_lora2e5_rank64/fine_tune_qformer_havenqwen_using_1989_57_with_lora_v0_cleaned_graph_3epoch_separate_lr_gnn8e4_qformer2e4_lora2e5_rank64.ckpt
...
res_path=/data/LPJ/ICML25/GraphCoder/eval_result/HiVerilog_expansion_result/fine_tune_qformer_havenqwen_using_1989_57_with_lora/v3_cleaned_graph_3epoch_separate_lr_gnn8e4_qformer2e4_lora2e5_rank64/tmp0.2
num_gpus=4
