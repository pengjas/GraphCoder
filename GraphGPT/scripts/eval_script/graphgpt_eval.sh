...
res_path=/data/LPJ/ICML25/GraphCoder/HiVerilog_eval_result/fine_tune_5layers_havenllama_using_shuffled_acl25_gpt4_unfreeze_gnn_projector_with_lora/v0_customized_440_rank64_best_ckpt_separate_lr_gnn1e4_projector1e4_lora5e5_2e4_batch2_epoch8
num_gpus=4
