...
res_path=/data/LPJ/ICML25/GraphCoder/eval_result/HiVerilog_expansion_result/adaptive/codellama/using_gnn_prj_from_pretrained_haven_graphcoder/v1_cleaned_graph_20epoch_separate_lr_gnn2e3_qformer5e4/tmp0.2
num_gpus=4
