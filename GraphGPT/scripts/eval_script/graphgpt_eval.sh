...
output_model=/data/LPJ/ICML25/all_checkpoints/fine_tuning_5layers_havenllama_specific_tasks_with_module_head/instr_reg/v0_seed0/v1_epoch14/haven_llama_5layers_instr_reg_v0_epoch14.ckpt
...
res_path=/data/LPJ/ICML25/GraphCoder/eval_result/HiVerilog_eval_result/fine_tune_5layers_specific_tasks_with_head/instr_reg/v0_seed0/v3_epoch14
num_gpus=1
