...
output_model=/data/LPJ/ICML25/all_checkpoints/fine_tuning_havenllama_gnn_projector_with_lora_using_shuffled_acl25_gpt4_with_module_head/resume_unified_lr_8e5_batch2_epoch15/haven_llama_shuffled_acl25_gpt4_with_module_head_resume_unified_lr_8e5_batch2_epoch15.ckpt
...
res_path=/data/LPJ/ICML25/GraphCoder/HiVerilog_eval_result/fine_tune_havenllama_using_shuffled_acl25_gpt4_unfreeze_gnn_projector_with_lora/v0_resume_best_ckpt_unified_lr_8e5_batch2_epoch15
num_gpus=4
