...
output_model=/data/LPJ/ICML25/all_checkpoints/fine_tuning_gnn_4layers_havenllama_using_1989_57_with_lora/v1_cleaned_graph_3epoch_separate_lr_gnn8e4_proj2e4_lora2e5_rank64/fine_tuning_gnn_4layers_havenllama_using_1989_57_with_lora_v1_cleaned_graph_3epoch_separate_lr_gnn8e4_proj2e4_lora2e5_rank64.ckpt
...
res_path=/data/LPJ/ICML25/GraphCoder/eval_result/HiVerilog_eval_expansion_result/fine_tune_4layers_havenllama_using_1989_57_with_lora/v1_cleaned_graph_3epoch_separate_lr_gnn8e4_proj2e4_lora2e5_rank64
num_gpus=4
