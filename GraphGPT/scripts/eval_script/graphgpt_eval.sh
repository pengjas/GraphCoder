...
output_model=/data/LPJ/ICML25/all_checkpoints/fine_tuning_gnn_projector_with_lora_using_rtlcoder_gpt4_v2_with_module_head/separate_lr_gnn3e8_projector3e4_lora3e5_batch2_epoch4/last.ckpt
...
res_path=/data/LPJ/ICML25/GraphCoder/HiVerilog_eval_result/fine_tune_using_rtlcoder_gpt4_unfreeze_gnn_projector_lora/v0_last_ckpt_separate_lr_gnn8e3_projector3e4_lora3e5_batch2_epoch4
num_gpus=4
