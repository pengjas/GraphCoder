...
output_model=/data/LPJ/ICML25/all_checkpoints/fine_tune_qformer_havenllama_using_1989_57_with_lora/v3_cleaned_graph_3epoch_separate_lr_gnn1e3_qformer5e4_lora4e5_rank32/fine_tune_qformer_havenllama_using_1989_57_with_lora_v3_cleaned_graph_3epoch_separate_lr_gnn1e3_qformer5e4_lora4e5_rank32.ckpt
...
res_path=/data/LPJ/ICML25/GraphCoder/eval_result/HiVerilog_expansion_result/fine_tune_qformer_havenllama_using_1989_57_with_lora/v3_cleaned_graph_3epoch_separate_lr_gnn1e3_qformer5e4_lora4e5_rank32/tmp0.2
num_gpus=4
...
# datapath=/data/LPJ/ICML25/GraphCoder/graphgpt_dataset/HiVerilog_expansion_eval/with_head/clean_graph/conversations.json
# graph_data_path=/data/LPJ/ICML25/GraphCoder/graphgpt_dataset/HiVerilog_expansion_eval/with_head/clean_graph/graph.jsonl
# res_path=/data/LPJ/ICML25/GraphCoder/eval_result/HiVerilog_expansion_result/pretrain_qformer_havenllama_using_1989_57_without_lora/v1_clean_graph_20epoch_separate_lr_gnn2e3_qformer5e4/tmp0.2
# num_gpus=4
# bert_path='/data/LPJ/bert/bert-L12-H128-uncased'
# bert_tokenizer_max_length=25
# # conv_mode=qwen
...
# model=/data/LPJ/ICML25/llamafactory/fine_tuned_model/haven_llama_stage2_1989_57/v1_clean_graph_3peoch
# output_file=eval_res
# output_dir=/data/LPJ/ICML25/llamafactory/inference_rslt/havenllama_3epochs_hiverilog_expansion/v2_clean_graph_max_length_6912/tmp0.2
