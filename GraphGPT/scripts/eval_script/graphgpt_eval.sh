...
output_model=/data/LPJ/ICML25/all_checkpoints/fine_tuning_5layers_havenllama_gnn_projector_with_lora_using_less_acl25_gpt4_with_module_head/with_val_01_lr_gnn1e4_projector1e4_lora5e5_epoch50/haven_llama_5layers_with_val_01_lr_gnn1e4_projector1e4_lora5e5_epoch50.ckpt
...
res_path=/data/LPJ/ICML25/GraphCoder/HiVerilog_eval_result/fine_tune_5layers_havenllama_using_less_acl25_gpt4_unfreeze_gnn_projector_with_lora/v1_with_val_rank64_lr_gnn1e4_projector1e4_lora5e5_epoch24
num_gpus=4
