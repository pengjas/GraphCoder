...
res_path=/data/LPJ/ICML25/GraphCoder/eval_result/shuffled_acl25_gpt4_1326_eval_result/fine_tuning_5layers_havenllama_gnn_projector_with_lora_using_shuffled_acl25_gpt4_with_module_head/v0_resume_rank64_separate_lr_gnn1e4_projector1e4_lora5e5_batch2_epoch20
num_gpus=4
