...
output_model=/data/LPJ/ICML25/all_checkpoints/pretrain_qformer_havenllama_using_1989_57_without_lora/v0_20epoch_separate_lr_gnn2e3_qformer5e4/codev_llama_qformer_1989_57_pretrain_without_lora_20epoch_separate_lr_gnn2e3_qformer5e4.ckpt
...
res_path=/data/LPJ/ICML25/GraphCoder/eval_result/HiVerilog_expansion_result/pretrain_qformer_codevllama_using_1989_57_without_lora/v0_20epoch_separate_lr_gnn2e3_qformer5e4/tmp0.2
num_gpus=4
