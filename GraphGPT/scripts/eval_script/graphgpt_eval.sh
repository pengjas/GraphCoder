...
output_model=/data/LPJ/ICML25/all_checkpoints/fine_tuning_with_eval_dataset_pretrained_separate_lr_gnn_prj_freeze_gnn_tuning_proj_lora/lr_3e4_batch2_70epoch/fine_tuning_with_eval_dataset_pretrained_separate_lr_gnn_prj_freeze_gnn_tuning_proj_lora_lr_3e4_batch2_70epoch.ckpt
...
res_path=/data/LPJ/ICML25/GraphCoder/HiVerilog_eval_result/fine_tune_using_my_gnn_separate_lr_tuning_projetor_without_lora/v0_lr_3e4_70epoch_2batch
num_gpus=4
