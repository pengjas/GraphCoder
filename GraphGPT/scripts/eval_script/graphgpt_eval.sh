...
output_model=/data/LPJ/ICML25/all_checkpoints/fine_tuning_5layers_havenllama_similar_logic_with_module_head/instr_reg/v0/epoch18/haven_llama_5layers_similar_logic_instr_reg_v0_epoch18.ckpt
...
res_path=/data/LPJ/ICML25/GraphCoder/eval_result/HiVerilog_eval_result/fine_tune_5layers_similar_logic_with_head/instr_reg/tmp0.2/v0_epoch18
num_gpus=1
