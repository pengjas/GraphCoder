...
output_model=/data/LPJ/ICML25/all_checkpoints/fine_tuning_gnn_4layers_havenllama_using_1989_57_with_lora/v1_cleaned_graph_3epoch_separate_lr_gnn8e4_proj2e4_lora2e5_rank64
bert_path=/data/LPJ/bert/bert-L12-H128-uncased
model_save_name=fine_tuning_gnn_4layers_havenllama_using_1989_57_with_lora_v1_cleaned_graph_3epoch_separate_lr_gnn8e4_proj2e4_lora2e5_rank64
if_val=False
...
tuned_proj_path=/data/LPJ/ICML25/all_checkpoints/projector/pretrain_gnn_4layers_havenqwen_using_1989_57_without_lora/v1_cleaned_graph_20epoch_separate_lr_gnn2e3_proj5e4/projector.bin
pretrain_input_embedding_path=/data/LPJ/ICML25/all_checkpoints/pretrain_4layers_havenllama_using_1989_57_without_lora/v1_cleaned_graph_20epoch_separate_lr_gnn2e3_proj5e4/pretrain_4layers_havenllama_using_1989_57_without_lora_v1_cleaned_graph_20epoch_separate_lr_gnn2e3_proj5e4.ckpt
