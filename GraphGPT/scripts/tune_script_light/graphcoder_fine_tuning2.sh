...
output_model=/data/LPJ/ICML25/all_checkpoints/fine_tuning_with_eval_dataset_pretrained_gnn_prj_freeze_gnn_tuning_proj_lora/lr_3e4_batch2_70epoch
bert_path=/data/LPJ/bert/bert-L12-H128-uncased
model_save_name=fine_tuning_with_eval_dataset_pretrained_gnn_prj_freeze_gnn_tuning_proj_lora_lr_3e4_batch2_70epoch
