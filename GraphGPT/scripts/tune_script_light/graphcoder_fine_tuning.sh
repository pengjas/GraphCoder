...
output_model=/data/LPJ/ICML25/all_checkpoints/fine_tune_qformer_havenllama_using_1989_57_with_lora/v1_5epoch_separate_lr_gnn3e4_qformer2e4_lora1e5_rank32
bert_path=/data/LPJ/bert/bert-L12-H128-uncased
model_save_name=haven_llama_qformer_1989_57_finetune_with_lora_5epoch_separate_lr_gnn3e4_qformer2e4_lora1e5_rank32
