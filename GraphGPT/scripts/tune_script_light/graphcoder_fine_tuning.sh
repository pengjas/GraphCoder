...
output_model=/data/LPJ/ICML25/all_checkpoints/pretrain_qformer_codellama_using_1989_57_without_lora/v0_cleaned_graph_20epoch_separate_lr_gnn2e3_qformer5e4
bert_path=/data/LPJ/bert/bert-L12-H128-uncased
model_save_name=pretrain_qformer_codellama_using_1989_57_without_lora_v0_cleaned_graph_20epoch_separate_lr_gnn2e3_qformer5e4
